...
总供应量：**100,000,000 NST**

| 类别 | 分配比例 | 数量 | 释放规则 |
|----------|------------|---------|---------|
| 流动性挖矿 | 50% | 50,000,000 | 无锁仓 |
| 团队与顾问 | 15% | 15,000,000 | 4年线性释放 |
| 生态基金 | 20% | 20,000,000 | 多重签名控制 |
| 社区空投 | 5% | 5,000,000 | TGE 释放 |
| 未来激励 | 10% | 10,000,000 | 未来决定 |

### NST 用途

- **治理**：投票决定协议参数
- **质押奖励**：赚取手续费和激励
- **手续费折扣**：NST 持有者享受交易费折扣
- **专属矿池**：获取高收益挖矿池的访问权限
