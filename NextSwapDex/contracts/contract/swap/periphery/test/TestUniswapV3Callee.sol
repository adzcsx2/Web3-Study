...
contract TestNextswapV3Callee is INextswapV3SwapCallback {
    ...
    function nextswapV3SwapCallback(
        ...
        if (amount0Delta > 0) {
            IERC20(INextswapV3Pool(msg.sender).token0()).transferFrom(
                sender,
                msg.sender,
            ...
            IERC20(INextswapV3Pool(msg.sender).token1()).transferFrom(
                sender,
                msg.sender,
