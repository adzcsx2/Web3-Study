...
/// @notice Provides validation for callbacks from Nextswap V3 Pools
library CallbackValidation {
    /// @notice Returns the address of a valid Nextswap V3 Pool
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) internal view returns (INextswapV3Pool pool) {
        return
            verifyCallback(
                factory,
